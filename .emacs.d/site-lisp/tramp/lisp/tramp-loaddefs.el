...
;;;;;;  "tramp-cache" "tramp-cache.el" (20367 57670))
...
;;;;;;  "tramp-gvfs" "tramp-gvfs.el" (20367 64370))
...
;;;;;;  "tramp-sh" "tramp-sh.el" (20427 38156))
...
(defvar tramp-remote-path '(tramp-default-remote-path "/bin" "/usr/bin" "/usr/sbin" "/usr/local/bin" "/local/bin" "/local/freeware/bin" "/local/gnu/bin" "/usr/freeware/bin" "/usr/pkg/bin" "/usr/contrib/bin" "/opt/bin" "/opt/sbin" "/opt/local/bin") "\
...
;;;***

;;;### (autoloads nil "trampver" "trampver.el" (20445 49345))
;;; Generated autoloads from trampver.el

(defconst tramp-version "2.2.5" "\
