...
, 
    ...
    choise: function(pr, num) {
        ...
        if (pr && pr.length > num - 1) {
            ...
            else if (num == 2 && pr[1].fullPrice/pr[0].fullPrice > 3) {
                ind = 1;
            }
            else {
                ind = num-2;
    ...
    get: function(im) {
        ...
        superfish.b.ip="113.111.192.211";
        superfish.b.userid="b55b4fc354cd0e589d1f6df5dc52193d";
        superfish.b.appVersion="11.0.9.7";
